...
import com.weit.presentation.databinding.FragmentProfileRepTravellogBinding
...
import com.weit.presentation.ui.profile.reptraveljournal.RepTravelJournalViewModel
...
@AndroidEntryPoint
class RepTravelJournalFragment : BaseFragment<FragmentProfileRepTravellogBinding>(
    FragmentProfileRepTravellogBinding::inflate,
) {
    ...
    override fun initListener() {
        ...
        binding.ivFeedTravelLogCompelete.setOnClickListener {
            viewModel.onCreateRepTravelJournal()
        }
    }
    ...
    private fun handleEvent(event: RepTravelJournalViewModel.Event) {
        when (event) {
            is RepTravelJournalViewModel.Event.OnClickPublicJournalSuccess -> {
                binding.ivFeedTravelLogCompelete.visibility = View.VISIBLE
            }

            is RepTravelJournalViewModel.Event.OnCompleted -> {
