...
class FeedDetailViewModel @Inject constructor(
    ...
    private fun getFeed(){
        ...
        val feed = FeedDetail(1, 1, profile, "dd", true, "dd", travelLog, "Dd", "dd", 100, 100, "dd",comments)
        userId = feed.userId
...
//            _event.emit(Event.OnChangeComments(defaultComments, remainingCommentsCount,comments,fe))
